...
Stats_function = function(option_list)
{
  ...
  DEF_colors_sel_2<-DEF_colors[which(DEF_colors$Annotation == "Fig2_Annot_Category"),]
  ...
  DEF_colors_sel_2$Annotation[which(DEF_colors_sel_2$Annotation == "Fig2_Annot_Category")]<-"MPRA_CLASS_2"
  DEF_colors_sel_2$Category[which(DEF_colors_sel_2$Category == "NON_ACTIVE")]<-"no_hit"
  DEF_colors_sel_2$Category[which(DEF_colors_sel_2$Category == "ACTIVE")]<-"hit"
  ...
  DEF_colors_sel_3<-DEF_colors_sel_2
  
  DEF_colors_sel_3$Annotation[which(DEF_colors_sel_3$Annotation == "MPRA_CLASS_2")]<-"M_and_M"
  DEF_colors_sel_3$Category[which(DEF_colors_sel_3$Category == "no_hit")]<-'No_Regulation_Detected|Unknown_mechanism'
  DEF_colors_sel_3$Category[which(DEF_colors_sel_3$Category == "hit")]<-'Transcriptional_Regulation|R_in_candidate'
  
  DEF_colors_sel_3$colors[which(DEF_colors_sel_3$colors == "gray")]<-"aquamarine4"
  ...
  DEF_colors_sel_4<-DEF_colors_sel_2
  
  DEF_colors_sel_4$Annotation[which(DEF_colors_sel_4$Annotation == "MPRA_CLASS_2")]<-"Multi_Lineage"
  DEF_colors_sel_4$Category[which(DEF_colors_sel_4$Category == "no_hit")]<-'Lineage_restricted'
  DEF_colors_sel_4$Category[which(DEF_colors_sel_4$Category == "hit")]<-'Multi_Lineage'
  
  DEF_colors_sel_4$colors[which(DEF_colors_sel_4$colors == "gray")]<-"gray"
  ...
  for(i in 1:length(category_vector))
  {
   ...
   #### DotPlot ----
    ...
    for(k in 1:length(array_GROUP))
    {
      ...
      Master_file_sel<-Master_file[which(Master_file$variable%in%df_subset_variables_sel$variable),]
